...
- While the other three are connected in series as a voltage divider sub-circuit (https://learn.sparkfun.com/tutorials/voltage-dividers/all). This reduces the voltage through the nail sensor circuit - which is essential as the Huzzah reads analogue readings up to 1V only.
